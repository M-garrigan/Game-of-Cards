...
// // generate new game
// const game = new Solitaire(d);

// const startGame = () => {alert('start')};
...
// A game of solitaire
export function Solitaire (deck) {
  ...
  this.flip = function () {
      if (this.pile.length === 0) {
          ...
          this.playableFlip = this.flipPile[this.flipPile.length - 1].rank 
              + this.flipPile[this.flipPile.length - 1].suit.slice(0,1);
      } 
      else {
